...
if (peak.set.to.use == "all") {
  mergedPeaksFile <- here('extractedData', 'allCondsMergedSummitWindows_mergedist50.bed') 
  outputFile <- here('extractedData', 'atacFragmentCountsAllCondsMergedSummitWindows_mergedist50.rds')
